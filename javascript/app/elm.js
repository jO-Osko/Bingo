...
var author$project$App$mapOther = function (nums) {
	return A2(
		elm$html$Html$span,
		_List_Nil,
		_List_fromArray(
...
var author$project$App$alreadyTaken = function (model) {
	var nums = function () {
		var _n0 = model.ao;
		if (!_n0.b) {
			return A2(
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						elm$html$Html$text(', '),
						author$project$App$mapOther(rest)
					]));
		}
	}();
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text('Padle številke:')
					])),
				nums
			]));
};
var author$project$Types$TakeNumber = {$: 5};
...
var author$project$App$drawButton = function (model) {
	var _n0 = model.az;
	if (!_n0) {
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									elm$html$Html$Attributes$class('col-md-3 btn btn-success'),
									elm$html$Html$Events$onClick(author$project$Types$TakeNumber)
								]),
							_List_fromArray(
								[
									elm$html$Html$text('Vzemi številko')
								]))
						]))
				]));
	}
};
var author$project$App$getClass = function (selected) {
	if (selected) {
		return ' taken ';
	} else {
		return ' available ';
...
var author$project$App$drawTile = F2(
	function (model, num) {
		return A2(
			elm$html$Html$div,
			_List_fromArray(
				[
					...
					'col-md-2 round text-center' + author$project$App$getClass(
						A2(elm$core$List$member, num, model.ao)))
				]),
			_List_fromArray(
				[
					A2(
...
var author$project$Types$NumTilesChange = function (a) {
	return {$: 4, a: a};
};
...
var author$project$App$numTilesInput = function (model) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text('Število izbir')
					])),
				A2(
				elm$html$Html$div,
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('input-group col-md-2')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								...
								elm$html$Html$Attributes$id('cost-input'),
								elm$html$Html$Events$onInput(author$project$Types$NumTilesChange)
							]),
						_List_Nil)
					]))
			]));
};
var author$project$Types$Reset = {$: 1};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text('Bingo')
					])),
				A2(
				elm$html$Html$img,
				_List_fromArray(
					[
						elm$html$Html$Attributes$src('img/logo2.png'),
						elm$html$Html$Attributes$class('float-right')
					]),
				_List_Nil),
				author$project$App$drawButton(model),
				A2(
				elm$html$Html$div,
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('md-3')
					]),
				_List_Nil),
				A2(
				elm$html$Html$div,
				...
				A2(
					elm$core$List$map,
					author$project$App$drawTile(model),
					A2(elm$core$List$range, 1, model.aE))),
				A2(
				elm$html$Html$div,
				_List_fromArray(
					[
				...
				_List_Nil),
				author$project$App$numTilesInput(model),
				author$project$App$alreadyTaken(model),
				A2(
				elm$html$Html$div,
				_List_Nil,
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$text('Začni')
							]))
					]))
			]));
};
var author$project$Types$NotStarted = 0;
var author$project$State$initialModel = {as: true, G: 0, az: 0, aD: 'Initial', aE: 0, H: _List_Nil, ao: _List_Nil};
var elm$core$Platform$Cmd$batch = _Platform_batch;
var elm$core$Platform$Cmd$none = elm$core$Platform$Cmd$batch(_List_Nil);
var author$project$State$init = function (_n0) {
	return _Utils_Tuple2(author$project$State$initialModel, elm$core$Platform$Cmd$none);
};
...
var author$project$State$shuffle = function (model) {
	return elm_community$random_extra$Random$List$shuffle(
		A2(elm$core$List$range, 1, model.aE));
};
var author$project$Types$Finished = 2;
var author$project$Types$Playing = 1;
var author$project$Types$Shuffled = function (a) {
	return {$: 3, a: a};
};
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 4:
				var nS = msg.a;
				var n = function () {
					var _n1 = elm$core$String$toInt(nS);
					if (_n1.$ === 1) {
						return model.G;
					} else {
						var x = _n1.a;
			...
			case 1:
				var newModel = _Utils_update(
					model,
					{az: 1, aE: model.G, ao: _List_Nil});
				var cmd = A2(
					elm$random$Random$generate,
					author$project$Types$Shuffled,
					author$project$State$shuffle(newModel));
				...
				var newModel = function () {
					...
					if (!_n2.b) {
						...
						return _Utils_update(
							...
							{
								H: rest,
								ao: A2(elm$core$List$cons, num, model.ao)
							});
					}
				}();
...
var author$project$App$main = elm$browser$Browser$element(
	{aC: author$project$State$init, aJ: author$project$State$subscriptions, aM: author$project$State$update, aO: author$project$App$view});
